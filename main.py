...
base_dir = Path("/mnt/data/demo_backend")
base_dir.mkdir(parents=True, exist_ok=True)

(main_file := base_dir / "main.py").write_text(main_py)
(requirements_file := base_dir / "requirements.txt").write_text(requirements_txt)

# Zip the files
zip_path = "/mnt/data/demo_backend.zip"
with zipfile.ZipFile(zip_path, 'w') as zipf:
    zipf.write(main_file, arcname="main.py")
    zipf.write(requirements_file, arcname="requirements.txt")
